...
[**🌐 Launch Live Web Application**](https://snehai.netlify.app/) • [**✨ Features**](https://snehai.netlify.app/features/) • [**🔒 Privacy Architecture**](https://snehai.netlify.app/privacy/) • [**📚 Documentation**](https://snehai.netlify.app/docs/)
...
| :--- | :--- | :--- |
| **App Launcher** | [snehai.netlify.app](https://snehai.netlify.app/) | Official Live Application Interface |
| **Features & Tech Stack** | [/features/](https://snehai.netlify.app/features/) | Complete breakdown of model hardware & tools |
| **Privacy Architecture** | [/privacy/](https://snehai.netlify.app/privacy/) | Official Zero-Retention privacy policy & DPDP Act compliance |
| **Security Specifications** | [/security/](https://snehai.netlify.app/security/) | Cloud infrastructure, TLS 1.3, and security policies |
| **Platform Documentation** | [/docs/](https://snehai.netlify.app/docs/) | User guides, shortcuts, and model navigation |
| **PWA Installation Guide** | [/install/](https://snehai.netlify.app/install/) | Step-by-step setup for iOS, Android, and Desktop |
| **Frequently Asked Questions** | [/faq/](https://snehai.netlify.app/faq/) | Detailed platform answers and billing information |
| **Version History** | [/changelog/](https://snehai.netlify.app/changelog/) | Active release updates and platform improvements |
| **Platform Comparison** | [/vs-chatgpt/](https://snehai.netlify.app/vs-chatgpt/) | Objective comparison between Snèh AI and ChatGPT |
...
### 🍏 iOS (iPhone / iPad)
1. Open **Safari** and visit `https://snehai.netlify.app/`.
2. Tap the **Share** icon at the bottom bar.
3. Scroll down and tap **Add to Home Screen**.

### 🤖 Android (Chrome / Edge)
1. Open **Chrome** and navigate to `https://snehai.netlify.app/`.
2. Tap the three dots menu in the top-right corner.
3. Select **Install App** or **Add to Home Screen**.

### 💻 Desktop (Windows / macOS / ChromeOS)
1. Visit `https://snehai.netlify.app/` in Chrome, Edge, or Brave.
