...
export function createMessageElement(content, isUser = false, msgIndex = null) {
  ...
  if (isUser) {
    ...
    shareBtn.onclick = async (e) => {
      ...
      const appUrl = 'https://snehai.netlify.app';
    ...
    pdfBtn.onclick = async (e) => {
      ...
      container.innerHTML = `
        <div style="font-family: 'Helvetica Neue', sans-serif; color:#1a1a1a; padding:40px; line-height:1.6; max-width:800px; margin:0 auto;">
          ...
          <div style="margin-top:50px; padding-top:20px; border-top:1px solid #eee; text-align:center; font-size:11px; color:#999;"><p style="margin:0;">Generated via Snèh AI • DBC Technologies, Narwana</p><p style="margin:4px 0 0 0; color:#0B57CF;">https://snehai.netlify.app</p></div>
        </div>
      `;
